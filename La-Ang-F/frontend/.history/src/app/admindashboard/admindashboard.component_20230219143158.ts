...
export class AdmindashboardComponent implements OnInit {
  ...
  const messageDropdown = document.querySelector(".dropdown-toggle");

// Ajouter une gestion d'événements de clic sur l'élément HTML de la messagerie
messageDropdown.addEventListener("click", (event) => {
  // Empêcher l'élément de se comporter par défaut
  event.preventDefault();

  // Afficher ou masquer le menu déroulant des messages
