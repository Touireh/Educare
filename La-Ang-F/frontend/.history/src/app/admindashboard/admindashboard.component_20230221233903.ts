...
import { CalendarOptions, EventsInput } from '@fullcalendar/core'; // useful for typechecking
...
@Component({
  ...
  styleUrls: ['./admindashboard.component.css','./css/sb-admin-2.min.css','./css/sb-admin-2.css','./css/message.css','./vendor/fontawesome-free/css/all.min.css']
})
