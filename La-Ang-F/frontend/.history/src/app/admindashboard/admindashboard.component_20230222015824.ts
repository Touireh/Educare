...
@Component({
  ...
  styleUrls: ['./admindashboard.component.css','./css/sb-admin-2.min.css','./css/sb-admin-2.css','./css/message.css','./css/calendar.css','./vendor/fontawesome-free/css/all.min.css']
})
export class AdmindashboardComponent implements OnInit {
  calendarOptions: CalendarOptions = {
    ...
    events: [
      ...
      { title: 'Compétition Sportive', date: '2023-02-22' }
    ]
  };
