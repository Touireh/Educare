...
export class ParentComponent implements OnInit {
  ...
  constructor(private ngZone:NgZone,private crud2Service: Crud2Service,private crud3Service: Crud3Service,private crudService: CrudService,private http: HttpClient,private authService: AuthService ) {}
